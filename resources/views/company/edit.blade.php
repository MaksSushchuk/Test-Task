...
<div class="container">
    ...
    <form method="POST" action="{{route('admin.company.update',$company->id)}}" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$company->name}}">
        </div>
        <div class="mb-3">
        ...
        <input type="text" name="website" class="form-control" id="exampleInputPassword1" value="{{$company->website ?? ''}}"> 
        </div>
